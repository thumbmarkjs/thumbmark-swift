...
public struct SysCtl {
    ...
    /// e.g. "8" or "2"
    public static var processorCount: Int32 { return try! SysCtl.value(ofType: Int32.self, forKeys: [CTL_HW, HW_NCPU]) }
    ...
    public static var kernelVersion: String { return try! SysCtl.string(for: [CTL_KERN, KERN_VERSION]) }
